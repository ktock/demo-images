...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'riscv64-node-container.data';
      var REMOTE_PACKAGE_BASE = 'riscv64-node-container.data';
...
Module['FS_createPath']("/", "pack", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_riscv64-node-container.data');

      };
      Module['addRunDependency']('datafile_riscv64-node-container.data');
    ...
    loadPackage({"files": [{"filename": "/pack/Image", "start": 0, "end": 4385280}, {"filename": "/pack/bbl.bin", "start": 4385280, "end": 4459418}, {"filename": "/pack/config", "start": 4459418, "end": 4459673}, {"filename": "/pack/rootfs.bin", "start": 4459673, "end": 68170905}], "remote_package_size": 68170905});
...
var wasmBinaryFile;
  wasmBinaryFile = 'riscv64-node-container.wasm';
